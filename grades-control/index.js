...
import gradesRouter from './src/routes/grade.js';
const { readFile, writeFile } = fs;

// <- Definindo o arquivo de forma global
global.filename = './src/grades/grades.json';
...
global.logger = winston.createLogger({
  level: 'silly',
  transports: [new winston.transports.Console(), new winston.transports.File({ filename: 'grades-control-api.log' })],
